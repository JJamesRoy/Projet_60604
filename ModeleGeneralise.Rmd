...
```{r plot-u15, out.height = "25%", fig.align='center', fig.cap="Distribution de u15"}
...
Nous allons donc interpréter le top 5 des arrondissements (comme indiqué dans le \@ref(tbl:tab-top)) avec le plus de stations uniques (dans notre échantillon de données).
...
```{#{r distRn-AM, out.height = "30%", fig.align = 'center', fig.cap = "Distribution de n_AM"}
#hist(dat$n_AM)
```
