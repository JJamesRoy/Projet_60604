...
Le modèle ci-dessus comporte les mêmes limitations que le modèle pour les déplacements en PM. En effet, celui-ci ne comporte pas d'interactions entre les variables. Cependant, nous sommes porter à croire qu'il en existe entre `mem` et `dur`, `mem` et `dur` ains qu'entre `dur` et les arondissements `arrond`.
