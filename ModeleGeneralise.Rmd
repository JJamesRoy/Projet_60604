...
Pour conclure, d’une part, nous utilisons la probabilité prédite des courts déplacements comme proxy pour la disponibilité des bixis dans certains arrondissements. Ce type d’information peut être décisive pour une entreprise comme Bixis. Comme mentionné précédemment, ce proxy est imparfait, il semble néanmoins fournir une idée de quels arrondissements à quel moment de l’année, les vélos, lorsqu’utilisé se font le plus usé.  
