...
bp <- boxplot(data_ferie_mem, data_nferie_mem, staplewex = 1,
              main = "Nombre de déplacements pour les membres",
              at = c(1,2),
              names = c("Férié", "Non-férié"),
              las = 2,
              col = c("orange","blue"),
              border = "black"
              )
text(x = col(bp$stats) - .5, y = bp$stats, labels = bp$stats, cex = 0.7)

bp <- boxplot(data_ferie_nmem, data_nferie_nmem, staplewex = 1,
              main = "Nombre de déplacements pour les non-membres",
              at = c(1,2),
              names = c("Férié", "Non-férié"),
              las = 2,
              col = c("orange","blue"),
...
text(x = col(bp$stats) - .5, y = bp$stats, labels = bp$stats, cex = 0.5)
...
Reste à faire d'après la station et mois de l'année...
