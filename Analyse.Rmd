...
```{r temp, fig.show="hold", out.width="50%"}
...
```{r rain, fig.show="hold", out.width="50%"}
...
La figure \@ref(fig:graphntotvstemp) montre la relation entre le nombre de déplacement total moyen par jour par rapport à la température pour les membres et les non-membres.
...
```{r graphTempVsMois}
 ...
 knitr::kable(mean_temp_vs_mm, col.names = c("Mois","Température moyenne (°C)"), caption = "Température moyenne par mois")
```

Par la suite, nous avons observé la relation entre le nombre de déplacement total moyen par jour d'après la quantité de précipitation tombés dans une journée. La figure \@ref(fig:graphNTotVsRain) montre cette relation.
...
La figure \@ref(fig:nTotVsDay) montre la relation entre le nombre de déplacement moyen pour différents moment de la journée et le nombre total de déplacement d'après la journée.
...
Le tableau \@ref(tab:nTotVsHoliday) montre la relation entre le nombre de déplacement et si la journée est férié ou non.
...
La figure \@ref(fig:nTotVsMois) représente la relation entre l'utilisation moyenne des Bixis et le mois de l'année.
...
Par la suite, nous avons identifié les stations qui généraient le plus de déplacements pour les membres et les non-membres. Les deux tableaux \@ref(tab:nTotVsStation) présentent le nombre de déplacements total des 5 stations avec le plus de déplacements pour les membres et les non-membres ainsi que l'arrondissement de Montréal où se situe ces stations.
