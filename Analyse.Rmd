...
```{r MatricCorr, fig.cap= "Matrice de corrlélation"}
my_colors  <- colorRampPalette(c("#BB4444", "#EE9988", "#FFFFFF", "#77AADD", "#4477AA"))(200)
corplot_dat <- dat %>% 
  select(-c(wday,mem))

corplot <- corrplot(cor(corplot_dat,use='pairwise.complete.obs'), method = "color",
         col = my_colors,  # Use the custom color palette here
...
=======
>>>>>>> 57b5b791246c3fe0c863c467c45e4ffe8f9438e4
