...
*De plus, En supposant que l'indépendance entre le nombre de déplacements n_tot et le terme d'erreur, une variation de 1% de la densité de la population serait associée, dans ce modèle, à une variation moyenne de 1.39 % du nombre de déplacements total en bixi pour les non-membre. Cependant, l'hypothèse d'indépendance n'est pas nécessairement respectée dans ce cas, puisqu'on sait qu'il y a des variables qui ne sont pas prises en compte, comme le nombre de pistes cyclables, etc. Cela étant dit, on peut tout de même affirmer que l'effet de la densité sur le nombre total de déplacements reste positif.* A VOIR SI J'AJOUTE
