...
Si nous analysons rapidement les résidus, nous voyons dans le figure à droite et à gauche \@ref(fig:fest-res2) qu'ils semblent légèrement plus normales que dans le premier modèle.
...
y = "Quantiles empiriques")+
  ggtitle("QQ-Plot Résidus Student")
