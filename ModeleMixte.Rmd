...
Pour conclure, le meilleur modèle avec l'effet de la densité de population est le modèle avec effets aléatoires sur l'ordonnée à l'origine et la variable de la fin de semaine et que les effets aléatoires sont indépendants. Pour le modèle sur les festivals, un modèle linéaire non-mixte est suffisant pour estimer l'impact des festivals sur le nombre de déplacements. 
=======
...
>>>>>>> 47c93658ffb1473c90f376e447c41674fa27eff3
